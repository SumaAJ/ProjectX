...
WebUI.click(findTestObject('IE_Home_ShowMoreDetail_Page/ShowLessDetail'))

WebUI.waitForElementPresent(findTestObject('IE_Home_ShowMoreDetail_Page/ShowMoreDetails'), GlobalVariable.Timeout)

String TextOfShowMoreDetail = WebUI.getText(findTestObject('IE_Home_ShowMoreDetail_Page/ShowMoreDetails'))

CustomKeywords.'getAllDetails_IE_HomePage.PrintStatement.getTextofElement'(TextOfShowMoreDetail)
